    ...
    public class BaseController : Controller
    {
        ...
        public BaseController()
        {
           ...
           // string[] roles = { "Anonymous"};
            //Thread.CurrentPrincipal = new GenericPrincipal(new GenericIdentity("Anonymous"), roles);

        }


        /// <summary>
        /// GET: Base, this should be the only anonymous request possible to the site
        /// </summary>
        [HttpGet]      
        ...
        //    // _user =   _ucda.CheckLoginCredentials(username, userpassword);
        //    //string[] roles = { _user.RoleNameShort };

        //    //Thread.CurrentPrincipal = new GenericPrincipal(new GenericIdentity(_user.Email), roles);
